...
public class FlashlightController
{
    ...
    private final ArrayList<WeakReference<FlashlightListener>> mListeners = new ArrayList<>(
            1);
    ...
    {
        mCameraManager = (CameraManager) mContext
    ...
    public void initialize()
    {
        ...
        {
            ensureHandler();
            mCameraManager.registerAvailabilityCallback(mAvailabilityCallback,
                    mHandler);
        }
    }
    ...
    {
        mSurfaceTexture = new SurfaceTexture(0, false);// TODO
    ...
    private String getCameraId() throws CameraAccessException
    {
        ...
        for (String id : ids)
        {
            CameraCharacteristics c = mCameraManager
                    .getCameraCharacteristics(id);
            Boolean flashAvailable = c
    ...
    public interface FlashlightListener
    {
        ...
        /**
         * Called when there is a change in availability of the flashlight
         * functionality
         * 
         * @param available
